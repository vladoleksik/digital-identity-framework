<?php
  ...
  if(isset($headers['Authorization']))
  {
    ...
    //print_r($jwtclaims);
    if($jwtclaims['client_id']!='412800e26513f4f0a7818a6ff1aa866ba2308bbbf607fa14716467238ca8c951')
    {
      echo "Access denied!";
      die();
    }
...
/*
  //old
  if(isset($headers['Authorization'])){
    if($headers['Authorization'] == 'Bearer ' . 'abcdefghijklmnopq')
    {
        echo '{
